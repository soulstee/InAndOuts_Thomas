...
void setup() {
  ...
  ITA = loadImage("backgrounds/ITA.jpg"); //i change it
  MEX = loadImage("backgrounds/MEX.jpg"); //change it
  IND = loadImage("backgrounds/IND.jpg");
  IRE = loadImage("backgrounds/IRE.jpg");
  USA = loadImage("backgrounds/USA.jpg"); //change it
...
CITATIONS
  ...
  ITALY: http://www.picswalls.com/pic/italy-wallpapers/
  MEXICO: https://wallpapercave.com/mexico-wallpaper
  INDIA: https://wallpapercave.com/india-wallpaper-desktop
  IRELAND: https://wallpapercave.com/ireland-desktop-backgrounds
  AMERICA: https://getwallpapers.com/collection/country-wallpaper-for-desktop-backgrounds
